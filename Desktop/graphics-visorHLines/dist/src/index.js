...
function pza1DerFunc() {
    var af = 10;
    Rota3D.initRotate(obj.w[400], obj.w[401], af * Math.PI / 180);
...
function desplazarTornilloIzquierda() {
    var tr = 0.2;
    for (var i = 201; i <= 208; i++) {
        obj.w[i].x = obj.w[i].x + tr;
    }
...
document.getElementById('moverPz').addEventListener('click', desplazarTornillo, false);
document.getElementById('moverPzIzq').addEventListener('click', desplazarTornilloIzquierda, false);
var Pix, Piy;
var Pfx, Pfy;
